...
public class EmployeeValidator {
     ...
     *
     * @param ev Employeeのインスタンス
     *
     * @param codeDuplicateCheckFlag社員番号の重複チェックを
     * 実施するかどうか（実施する:true 実施しない:false）
     *
     * @param passwordCheckFlag パスワードの入力チェックを
     * 実施するかどうか（実施するか:true 実施しない:false）
     *
     * @return エラーのリスト
     */

    public static List<String> validate(
            EmployeeService service, EmployeeView ev, Boolean codeDuplicateFlag, Boolean passwordCheckFlag) {
         ...
         * @param code 社員番号
         *
         * @param codeDuplicateCheckFlag 社員番号の重複チェックを実施するかどうか
        ...
        private static String validateCode(EmployeeService service, String code, Boolean codeDuplicateCheckFlag) {
            ...
            if (codeDuplicateCheckFlag) {
                ...
                if (employeesCount > 0) {
                    return MessageConst.E_EMP_CODE_EXIT.getMessage();
                }
            }
        ...
        /**
         * @param service EmployeeService のインスタンス
         *
         * @param code 社員番号
         *
        ...
        private static String valicatePassword(String password, Boolean passwordCheckFlag) {

            //入力チェックを実施　かつ　入力値がなけえればエラーメッセージを返却
